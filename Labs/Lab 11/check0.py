...
class BallDraw(object):
    def __init__ (self, parent):
        ...
        self.ball_radius = 10
        self.ball_dx,self.ball_dy = 6,-10    # the movement of the ball object
    ...
    def animate(self):
        ...
        while 0 < self.ball_x + self.ball_radius and self.ball_x - self.ball_radius < self.maxx and 0 < self.ball_y + self.ball_radius and self.ball_y - self.ball_radius < self.maxy and not self.isstopped:
            # Move the ball
            self.draw_ball()
